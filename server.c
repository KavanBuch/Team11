...
void *thread_fn_no_param2(void *arg)
{
    pthread_mutex_lock(&mymutex);
...
void write_text1(int sockfd)
{
    ...
    printf("Hello1\n");
    pthread_t threadID;
    int err = pthread_create(&threadID, NULL, thread_fn_no_param2, NULL);
...
int main()
{
    ...
    for (int i = 1; i <= 6; i++)
    {
        ...
        {
            write_text1(new_sock); // receive text file and run your own code
        }
